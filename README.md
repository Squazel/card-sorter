...
### Sort Logic
The file `sort_logic.py` contains the consolidated card sorting algorithm:
...
For detailed information about the algorithm, its theoretical foundations, complexity analysis, and optimization strategies, please see [ALGORITHM.md](ALGORITHM.md).
